...
RAILS_ENV=production bundle install --binstubs /home/ubuntu/apps/globalwork/shared/bin --gemfile ./Gemfile --path /home/ubuntu/apps/globalwork/shared/bundle --without development test --deploy --quiet